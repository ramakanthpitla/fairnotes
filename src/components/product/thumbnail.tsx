      ...
      try {
        ...
        if (cached) {
          try {
            ...
            console.warn('Failed to parse cached thumbnail data', e);
        ...
        try {
          ...
          if (!res.ok) {
            // If the API returns an error, use a default image
          ...
          if (!data.url) {
            console.warn('Invalid response from thumbnail API:', data);
          ...
          console.warn('Error in thumbnail processing:', err);
